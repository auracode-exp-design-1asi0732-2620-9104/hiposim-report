...
<table style="width: 100%; border-collapse: collapse; margin: 18px 0; page-break-inside: auto;">
  <!-- MEMBER 1 -->
  <tr style="page-break-inside: avoid;">
    ...
    <td style="text-align: justify; width: 68%; vertical-align: top; border: 1px solid #CBD5E1; padding: 14px; line-height: 1.55;">
      <h3 style="margin: 0 0 12px 0; color: #0E5C63;">Bautista Rivera, Jose Diego</h3>
      <p style="margin: 6px 0;">
        <strong>Código de estudiante:</strong> U202310949
      </p>
      <p style="margin: 6px 0;">
      ...
      <p style="margin: 6px 0;">
        <strong>Sobre mí:</strong> Soy estudiante de Ingeniería de Software en la UPC. Cuento con conocimientos técnicos en desarrollo frontend con Vue, HTML, CSS y JavaScript; en desarrollo backend con C#, ASP.NET Core y APIs REST; y en diseño y gestión de bases de datos. También tengo experiencia en control de versiones con Git y GitFlow, así como en la elaboración de documentación técnica.
      </p>
      <p style="margin: 10px 0 6px 0;">
        Puedo contribuir al proyecto con una visión integral del desarrollo de software, desde la interfaz de usuario hasta el servicio y la base de datos que la respaldan. Asimismo, puedo aportar buenas prácticas de trabajo colaborativo y documentación para mantener el proyecto ordenado y trazable.
      </p>
    </td>
  </tr>
  ...
  <tr style="page-break-inside: avoid;">
    ...
    <td style="text-align: justify; width: 68%; vertical-align: top; border: 1px solid #CBD5E1; padding: 14px; line-height: 1.55;">
      <h3 style="margin: 0 0 12px 0; color: #0E5C63;">Carlos Lavado, Ever Giusephi</h3>
      <p style="margin: 6px 0;">
        <strong>Código de estudiante:</strong> U202224867
      </p>
      <p style="margin: 6px 0;">
  ...
  <tr style="page-break-inside: avoid;">
    ...
    <td style="text-align: justify; width: 68%; vertical-align: top; border: 1px solid #CBD5E1; padding: 14px; line-height: 1.55;">
      <h3 style="margin: 0 0 12px 0; color: #0E5C63;">Daga Chávez, Joaquín Leonardo</h3>
      <p style="margin: 6px 0;">
  ...
  <tr style="page-break-inside: avoid;">
    ...
    <td style="text-align: justify; width: 68%; vertical-align: top; border: 1px solid #CBD5E1; padding: 14px; line-height: 1.55;">
      <h3 style="margin: 0 0 12px 0; color: #0E5C63;">Janampa Gutierrez, Jhoan Darner</h3>
      <p style="margin: 6px 0;">
        <strong>Código de estudiante:</strong> U202323319
      </p>
      <p style="margin: 6px 0;">
        <strong>Edad:</strong> 20
      </p>
      ...
      <p style="margin: 6px 0;">
        <strong>Sobre mí:</strong> Soy estudiante de séptimo ciclo de Ingeniería de Software en la UPC. Cuento con conocimientos técnicos en desarrollo frontend con Angular y Vue.js, gestión del control de versiones con Git y GitFlow, y consumo de APIs REST. También cuento con certificaciones en metodologías ágiles y Scrum, lo que me permite aportar tanto en el aspecto técnico como en la organización del equipo.
      </p>
      <p style="margin: 10px 0 6px 0;">
        Puedo contribuir al proyecto con mi experiencia en desarrollo web, buenas prácticas de trabajo colaborativo —como GitFlow y control de versiones— y un enfoque orientado a mantener al equipo organizado para cumplir con entregables de calidad dentro de los plazos establecidos.
      </p>
    </td>
  </tr>
  ...
  <tr style="page-break-inside: avoid;">
    <td style="text-align: center; width: 32%; vertical-align: middle; border: 1px solid #CBD5E1; padding: 14px; background-color: #F8FAFC;">
      ...
      alt="Foto de perfil de Franco López"
      width="70%"
      style="border-radius: 10px; max-width: 180px; height: auto;">
    </td>
    <td style="text-align: justify; width: 68%; vertical-align: top; border: 1px solid #CBD5E1; padding: 14px; line-height: 1.55;">
      <h3 style="margin: 0 0 12px 0; color: #0E5C63;">López Roman, Franco Mauricio</h3>
      <p style="margin: 6px 0;">
        <strong>Código de estudiante:</strong> U202315890
      </p>
      <p style="margin: 6px 0;">
        <strong>Carrera:</strong> Ingeniería de Software
      </p>
      <p style="margin: 6px 0;">
        <strong>Sobre mí:</strong> Soy estudiante de Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas. Tengo experiencia en proyectos que incluyen C++, Python, HTML, CSS y MongoDB, además de conocimientos en JavaScript, TypeScript y Java. Me considero una persona responsable y comprometida, que brinda su mayor esfuerzo al proyecto y mantiene una comunicación efectiva para el trabajo en equipo.
      </p>
    </td>
  </tr>
  ...
  <tr style="page-break-inside: avoid;">
    ...
    <td style="text-align: justify; width: 68%; vertical-align: top; border: 1px solid #CBD5E1; padding: 14px; line-height: 1.55;">
      <h3 style="margin: 0 0 12px 0; color: #0E5C63;">Olivares Lao, Gustavo Alonso</h3>
      <p style="margin: 6px 0;">
        <strong>Código de estudiante:</strong> U202216448
      </p>
      <p style="margin: 6px 0;">
      ...
      <p style="margin: 6px 0;">
        <strong>Sobre mí:</strong> Soy estudiante de Ingeniería de Software (octavo ciclo, UPC) y desarrollador front-end junior. Estoy especializado en React, JavaScript y Python, con un fuerte enfoque en análisis de datos e integración de inteligencia artificial. Busco integrarme en un equipo colaborativo para optimizar procesos, aportar soluciones y continuar mi crecimiento profesional.
      </p>
    </td>
  </tr>
</table>
...
<div style="margin: 16px 0 10px 0; padding: 10px 14px; background-color: #E7F3F3; border-left: 5px solid #0E5C63; page-break-inside: avoid;">
  <strong>Enunciado del problema</strong>
</div>
...
- Suponemos que un simulador accesible desde el móvil aumenta la interacción, ya que los usuarios objetivo investigan este tipo de decisión de manera informal, fuera de una sesión bancaria desde una computadora.
- Suponemos que un reporte en PDF exportable y compartible aumenta la confianza y se utiliza para conversar sobre la simulación con la pareja, un familiar o el propio banco.
...
<table style="width: 100%; border-collapse: collapse; margin: 18px 0; page-break-inside: auto;">
  <tr style="page-break-inside: avoid;">
    <td style="width: 25%; vertical-align: top; border: 1px solid #94A3B8; padding: 12px; text-align: justify; line-height: 1.45;">
      <strong>1. Problema de negocio</strong><br>
    ...
    <td style="width: 25%; vertical-align: top; border: 1px solid #94A3B8; padding: 12px; text-align: justify; line-height: 1.45;">
      <strong>2. Resultados de negocio</strong><br>
  ...
  <tr style="page-break-inside: avoid;">
    ...
    <td style="width: 25%; vertical-align: top; border: 1px solid #94A3B8; padding: 12px; text-align: justify; line-height: 1.45;">
      <strong>8. ¿Qué es lo más importante que necesitamos aprender primero?</strong><br>
